...
# Button to navigate to behavioral interview
if st.button("Proceed to Behavioral Interview"):
    st.session_state["page"] = "behavioural_round"
    st.experimental_rerun()

# Check if the page should be switched
if st.session_state.get("page") == "behavioural_round":
    st.experimental_set_query_params(page="behavioural_round")
    st.experimental_rerun()